...
<div class="card">
    <div class="card-body">
        ...
        <form class="row g-3" action="{{route('ajouter_article')}}" method="post" enctype="multipart/form-data">
            @method('post')
            @csrf
            <div class="col-md-12">
            ...
            <div class="col-md-12">
                ...
                <div class="col-md-12">
                    <input type="text" class="form-control" name="nombreToilette">
                </div>
            </div>
            <div class="col-md-12">
                <label class="form-label">Nombre de Balcon</label><br>
                <div class="col-md-12">
                    <input type="text" class="form-control" name="nombreBalcon">
                </div>
            </div>
            <div class="col-md-12">
